        ...
        >
          ...
          >
            ...
            >
              <TabsTrigger
                value="appearance"
                className="flex-none justify-start px-3 md:px-4 py-3 h-auto data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm border border-transparent rounded-lg"
              >
