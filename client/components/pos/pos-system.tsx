...
const sampleCustomers: Customer[] = [
  { id: "1", name: "John Doe", phone: "08012345678", loyaltyPoints: 250 },
  { id: "2", name: "Jane Smith", phone: "08087654321", loyaltyPoints: 180 },
  { id: "3", name: "David Johnson", phone: "08098765432", loyaltyPoints: 320 },
]
...
export function POSSystem() {
  ...
  const updateQuantity = (id: string, newQuantity: number) => {
    ...
    setCart(
      cart.map((item) =>
        item.id === id ? { ...item, quantity: newQuantity, subtotal: item.price * newQuantity } : item,
      ),
    )
  }
  ...
  const discount = selectedCustomer ? Math.floor(selectedCustomer.loyaltyPoints / 10) * 5 : 0
  ...
  const handlePayment = () => {
    ...
    const transaction = {
      ...
      change: paymentMethod === "cash" ? Number.parseFloat(amountPaid) - total : 0,
    }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif font-bold text-3xl text-foreground">Point of Sale</h1>
        <p className="text-muted-foreground mt-2">Process sales transactions and manage customer orders</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Search by name, brand, generic name, or scan barcode</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="font-serif font-semibold">Available Medicines</CardTitle>
              <CardDescription>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="font-bold text-accent">{formatCurrency(medicine.price)}</span>
                          <Badge
                            variant={medicine.stock > 10 ? "default" : medicine.stock > 0 ? "outline" : "destructive"}
                            className="text-xs"
                          >
                ...
                <div className="p-3 bg-muted rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-accent">{selectedCustomer.loyaltyPoints} loyalty points</p>
                    </div>
              ...
              {cart.length > 0 && (
                <>
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button onClick={() => setShowPaymentDialog(true)} className="flex-1 bg-accent hover:bg-accent/90">
                      Checkout
                    </Button>
                  </div>
                </>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
              ...
              <div>
                ...
                {amountPaid && Number.parseFloat(amountPaid) >= total && (
                  <p className="text-sm text-muted-foreground mt-1">
                    Change: {formatCurrency(Number.parseFloat(amountPaid) - total)}
                  </p>
                )}
              </div>
            )}
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={handlePayment} className="flex-1 bg-accent hover:bg-accent/90">
                Process Payment
              </Button>
            </div>
          </div>
          ...
          {lastTransaction && (
            <div className="space-y-4">
              <div className="text-center p-4 bg-muted rounded-lg">
                <p className="font-bold text-lg text-accent">Payment Successful!</p>
