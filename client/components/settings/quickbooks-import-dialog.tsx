...
import { importQuickbooksData } from "@/lib/db/queries/setup";
    ...
    <ResponsiveModal
      ...
      footer={
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
          {!!importComplete && <Button onClick={handleClose}>Done</Button>}
          {!importComplete && (
            <>
              <Button
                variant="outline"
              ...
              <Button
                ...
                disabled={isImporting || (!importProducts && !importCustomers)}
              >
                {isImporting && (
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(v: "skip" | "overwrite") =>
                setDuplicateStrategy(v)
              }
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="overwrite">
                  Overwrite prices and stock for existing records
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
