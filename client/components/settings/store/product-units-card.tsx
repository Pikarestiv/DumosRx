  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Add custom selling or pack units for your products, on top of the built-in list.
        </CardDescription>
      </CardHeader>
          ...
          {customUnits.length === 0 ? (
            ...
            <div className="flex flex-wrap gap-2">
              {customUnits.map((unit) => (
                <Badge key={unit} variant="secondary" className="gap-1.5 pr-1 py-1.5">
                  {unit}
                  <button
                    type="button"
        ...
        <div className="space-y-2 rounded-lg border p-4">
          ...
          <div className="flex flex-wrap gap-1.5 pt-1">
            {FORM_SUGGESTIONS.common.units.map((unit) => (
              <Badge key={unit} variant="outline" className="text-xs font-normal">
                {unit}
              </Badge>
            ))}
          </div>
