...
5. **Free Trial (7 Days)**: Upon registration, new users automatically start on a 7-Day Pro Free Trial. If they do not subscribe to a paid tier when the trial expires, they are automatically downgraded to the **Free** tier. All staff accounts beyond the owner/admin are suspended, and premium modules are locked.
