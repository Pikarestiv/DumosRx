...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $customers = Customer::where('user_id', $this->tenantOwnerId($request))
            ->latest()
            ->paginate($limit);
    ...
    {
        $customer = Customer::where('user_id', $this->tenantOwnerId($request))
            ->with('sales')
            ->findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        $customer->user_id = $this->tenantOwnerId($request);
        $customer->save();
    ...
    #[OA\Patch(
        path: '/app/customers/{customer}',
        summary: 'Update a customer (PATCH alias of PUT)',
        tags: ['Customers'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'customer', in: 'path', required: true, schema: new OA\Schema(type: 'string'))],
    ...
    {
        $customer = Customer::where('user_id', $this->tenantOwnerId($request))->findOrFail($id);
