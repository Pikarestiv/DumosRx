        ...
        <header className="h-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-80 p-0 border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="max-h-[350px] overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800">
                  {notifications.map((n: any, index: number) => (
                    ...
                    >
                      ...
                      <p className="text-sm font-bold text-slate-900 dark:text-white mt-1 leading-tight">{n.title}</p>
                      <p className="text-xs text-slate-500 mt-0.5 leading-normal line-clamp-2">{n.description}</p>
                    </div>
                  ))}
