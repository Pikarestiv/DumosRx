      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
        <div className="container flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold tracking-tight">Dumos<span className="text-primary">Rx</span></span>
          </Link>
            ...
            <Sheet>
              ...
              <SheetContent>
                <div className="flex flex-col gap-6 mt-12">
                  <Link href="#features" className="text-xl font-bold">Features</Link>
                  <Link href="#benefits" className="text-xl font-bold">Benefits</Link>
                  <Link href="#pricing" className="text-xl font-bold">Pricing</Link>
                  <Separator />
              ...
              <div className="absolute -top-6 -right-6 hidden lg:block">
                 <div className="bg-background border rounded-2xl p-6 shadow-xl flex items-center gap-4">
                    ...
                    <div className="text-left">
                       ...
                       <p className="text-xs text-muted-foreground">Meets local standards</p>
                    </div>
                 </div>
              </div>
            </div>
        ...
        <section className="py-20 border-y bg-muted/30">
          <div className="container px-4 mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 items-center opacity-50 grayscale hover:grayscale-0 transition-all">
               <div className="flex justify-center"><p className="text-2xl font-black italic">HEALTHPLUS</p></div>
               <div className="flex justify-center"><p className="text-2xl font-black italic">MEDPLUS</p></div>
               <div className="flex justify-center"><p className="text-2xl font-black italic">NETCARE</p></div>
               <div className="flex justify-center"><p className="text-2xl font-black italic">EMZOR</p></div>
               <div className="flex justify-center"><p className="text-2xl font-black italic">FIDSON</p></div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="py-32">
          <div className="container px-4 mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-base font-bold text-primary tracking-wide uppercase mb-3">Core Features</h2>
              <p className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">Everything you need to run a modern pharmacy</p>
              <p className="text-xl text-muted-foreground leading-relaxed">
                We&apos;ve built DumosRx with the specific challenges of Nigerian healthcare in mind. 
                Powerful tools that work where you are.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Automated stock alerts, expiry tracking, and intelligent reordering logic.",
                  icon: Database,
                  color: "blue"
                },
                {
                  title: "Fast POS Checkout",
                  description: "Process sales in seconds. Supports multiple payment modes including bank transfers.",
                  icon: Zap,
                  color: "green"
                },
                {
                  title: "Financial Intelligence",
                  description: "Real-time profit/loss, daily reports, and EOD reconciliations.",
                  icon: BarChart3,
                  color: "purple"
                },
                {
                  title: "Regulatory Compliance",
                  description: "Automatic PCN-compliant records and professional digital receipts.",
                  icon: Shield,
                  color: "red"
                },
                {
                  title: "CRM & Loyalty",
                  description: "Track customer history and build loyalty with reward points.",
                  icon: Users,
                  color: "indigo"
                },
                {
                  title: "Multi-Platform",
                  description: "Run on Windows, Mac, or Tablet. All data syncs to the cloud securely.",
                  icon: Smartphone,
                  color: "orange"
                }
              ].map((feature, i) => (
                <Card key={i} className="group hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 border-muted bg-card/50 backdrop-blur">
                  <CardHeader>
        ...
        <section id="benefits" className="py-24 bg-slate-900 text-white overflow-hidden">
           <div className="container px-4 mx-auto">
              <div className="grid lg:grid-cols-2 gap-20 items-center">
                 <div>
                    <h2 className="text-4xl md:text-5xl font-extrabold mb-8 tracking-tight">Built for Nigeria&apos;s <br /> Infrastructure</h2>
                    <div className="space-y-8">
                       <div className="flex gap-6">
                          ...
                          <div>
                             ...
                             <p className="text-slate-400">Continue making sales and managing stock even when your internet is down. DumosRx syncs automatically once you&apos;re back online.</p>
                          </div>
                       </div>
                       <div className="flex gap-6">
                          <div className="flex-shrink-0 w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center">
                          ...
                          <div>
                             <h3 className="text-xl font-bold mb-2">Power Failure Protection</h3>
                             <p className="text-slate-400">Our local-first architecture ensures no data is lost during sudden power outages or system shutdowns.</p>
                          </div>
                       </div>
                       <div className="flex gap-6">
                          <div className="flex-shrink-0 w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center">
                          ...
                          <div>
                             <h3 className="text-xl font-bold mb-2">Bank Transfer Verification</h3>
                             <p className="text-slate-400">Specially designed POS flow for the Nigerian market, supporting quick bank transfer verification and split payments.</p>
                          </div>
                       </div>
                    </div>
                 ...
                 <div className="relative">
                    ...
                    <div className="absolute -top-10 -right-10 bg-primary p-8 rounded-2xl shadow-2xl hidden xl:block">
                       ...
                       <p className="text-sm font-bold uppercase tracking-widest opacity-80">System Uptime</p>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <section className="py-32 bg-muted/30">
           <div className="container px-4 mx-auto max-w-4xl">
              <div className="text-center mb-16">
                 ...
                 <p className="text-muted-foreground">Everything you need to know about DumosRx</p>
              </div>
              <div className="space-y-6">
                 {[
                    { q: "Is DumosRx easy to learn?", a: "Yes! Most pharmacists and cashiers master DumosRx in less than 30 minutes. Our interface is intuitive and mirrors real pharmacy workflows." },
                    { q: "Does it work on a laptop?", a: "Absolutely. DumosRx works on Windows and Mac. You can also access reports on your mobile phone via the cloud dashboard." },
                    { q: "What happens if my computer crashes?", a: "Your data is automatically synced to the DumosRx cloud whenever you have internet. You can restore your entire database to a new machine in minutes." },
                    { q: "Is the software PCN compliant?", a: "Yes, DumosRx generates all mandatory PCN records and handles batch numbers and expiry tracking exactly as required by Nigerian law." }
                 ].map((faq, i) => (
                    <div key={i} className="bg-background border rounded-2xl p-8 shadow-sm">
            ...
            <div className="bg-primary rounded-[3rem] p-12 md:p-24 text-white text-center relative overflow-hidden shadow-2xl shadow-primary/20">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl mb-12 opacity-90 max-w-2xl mx-auto leading-relaxed">
                  Join 500+ forward-thinking pharmacies across Nigeria. Start your
                  14-day risk-free trial today. No credit card required.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://wa.me/2348000000000">Chat with Sales</Link>
                  </Button>
                </div>
              </div>
            </div>
      ...
      <footer className="pt-24 pb-12 bg-slate-900 text-slate-400">
        <div className="container px-4 mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="space-y-6">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-white tracking-tight">DumosRx</span>
              </Link>
              <p className="text-sm leading-relaxed">
                The #1 Pharmacy Management System in Nigeria. Trusted by 500+ pharmacists to provide world-class healthcare.
              </p>
              <div className="flex space-x-4">
                 {/* Social Icons Placeholder */}
                 <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors cursor-pointer"><Globe className="w-4 h-4 text-white" /></div>
                 <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors cursor-pointer"><Smartphone className="w-4 h-4 text-white" /></div>
                 <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors cursor-pointer"><Zap className="w-4 h-4 text-white" /></div>
              </div>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-slate-800 text-center text-xs">
            <p>&copy; {new Date().getFullYear()} Dumos Technologies. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
