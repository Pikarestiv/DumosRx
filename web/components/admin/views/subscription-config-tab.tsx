...
export function SubscriptionConfigTab() {
  ...
  const [config, setConfig] = useState<SubscriptionConfig>({
    ...
    tiers: {
      free: { price_monthly: 0, price_yearly: 0, active: true, limits: { staff: 1, stores: 1, sync_interval: 360 }, features: { cloud_sync: false, web_dashboard: false, mobile_app: false, ecommerce: false, smart_pos: true, custom_branding: false, remove_branding: false, broadcast_create: false, daily_summary_email: false, multi_store: false, procurement: false, prescriptions: false, expenses: false, audit_mode: false, dark_mode: true, smart_suggestions: false, auto_lock: true, barcode_generation: false, loyalty_program: false, advanced_reports: false, reseller_commission: false, proforma_quotes: false, daily_close_report: false } },
      starter: { price_monthly: 3000, price_yearly: 30000, active: true, limits: { staff: 3, stores: 1, sync_interval: 30 }, features: { cloud_sync: true, web_dashboard: true, mobile_app: false, ecommerce: false, smart_pos: true, custom_branding: false, remove_branding: false, broadcast_create: false, daily_summary_email: false, multi_store: false, procurement: true, prescriptions: true, expenses: true, audit_mode: false, dark_mode: true, smart_suggestions: false, auto_lock: true, barcode_generation: true, loyalty_program: false, advanced_reports: false, reseller_commission: false, proforma_quotes: false, daily_close_report: true } },
      pro: { price_monthly: 8000, price_yearly: 80000, active: true, limits: { staff: 10, stores: 3, sync_interval: 15 }, features: { cloud_sync: true, web_dashboard: true, mobile_app: true, ecommerce: false, smart_pos: true, custom_branding: true, remove_branding: true, broadcast_create: true, daily_summary_email: true, multi_store: true, procurement: true, prescriptions: true, expenses: true, audit_mode: true, dark_mode: true, smart_suggestions: true, auto_lock: true, barcode_generation: true, loyalty_program: true, advanced_reports: true, reseller_commission: true, proforma_quotes: true, daily_close_report: true } },
      enterprise: { price_monthly: 15000, price_yearly: 150000, active: true, limits: { staff: 50, stores: 20, sync_interval: 0 }, features: { cloud_sync: true, web_dashboard: true, mobile_app: true, ecommerce: true, smart_pos: true, custom_branding: true, remove_branding: true, broadcast_create: true, daily_summary_email: true, multi_store: true, procurement: true, prescriptions: true, expenses: true, audit_mode: true, dark_mode: true, smart_suggestions: true, auto_lock: true, barcode_generation: true, loyalty_program: true, advanced_reports: true, reseller_commission: true, proforma_quotes: true, daily_close_report: true } },
    }
  });
      ...
      setConfig({
        ...
        tiers: {
          free: {
            ...
            features: serverConfig.tiers?.free?.features ?? { cloud_sync: false, web_dashboard: false, mobile_app: false, ecommerce: false, smart_pos: true, custom_branding: false, remove_branding: false, broadcast_create: false, daily_summary_email: false, multi_store: false, procurement: false, prescriptions: false, expenses: false, audit_mode: false, dark_mode: true, smart_suggestions: false, auto_lock: true, barcode_generation: false, loyalty_program: false, advanced_reports: false, reseller_commission: false, proforma_quotes: false, daily_close_report: false },
          },
          starter: {
