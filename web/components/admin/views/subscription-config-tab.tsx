      ...
      setConfig({
        ...
        tiers: {
          ...
          pro: {
            ...
            limits: serverConfig.tiers?.pro?.limits ?? { staff: 15, stores: 3, sync_interval: 15 },
