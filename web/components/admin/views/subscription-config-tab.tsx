      ...
      setConfig({
        ...
        tiers: {
          ...
          enterprise: {
            ...
            limits: serverConfig.tiers?.enterprise?.limits ?? { staff: -1, stores: -1, sync_interval: 0 },
