...
export function FleetStoreDetailsView({ storeId, stores }: { storeId?: string, stores?: any[] }) {
  ...
  if (!store) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button onClick={() => router.push('/dashboard/fleet')}>Back to Fleet</Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
        <div className="flex items-center gap-4">
            <Button variant="outline" size="sm" onClick={() => router.push('/dashboard/fleet')}>
                &larr; Back
            </Button>
